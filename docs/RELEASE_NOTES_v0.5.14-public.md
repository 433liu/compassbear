...
This is the sanitized public release of CompassBear Academic Compass. It removes private API keys, generated outputs, personal source notes, personal mentor lenses and project-specific examples that could reveal an unpublished manuscript direction.
...
- No unpublished-project-specific material, terms or examples.
...
`compass-bear-v0.5.14-public.zip`
